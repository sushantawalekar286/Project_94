...
const QuantitySelector = ({ value, onChange, min = 1, max = 10, disabled = false }) => {
  return (
    <div className={`flex items-center gap-2 bg-dark-700 rounded-lg p-2 w-fit ${disabled ? "opacity-50 cursor-not-allowed pointer-events-none" : ""}`}>
      <motion.button
